...
import { BsFacebook, BsYoutube, BsGithub, BsInstagram, BsLinkedin, BsTwitter, BsTwitterX } from 'react-icons/bs'
  ...
  return (
    <Container className='p-10 bg-black text-gray-100 flex items-center justify-between'>
        ...
        <p className='text-sm text-gray-300'>©All rights reserved{""}
            <Link href={""} target='_blank' className='hover:text-white font-semibold duration-200' >@reactjd</Link>
        </p>
    </Container>
  )
}
